...
#: docs/archive/reports/U5A_REPORT.md находка U5A-6). НЕ входит в KINDS: это не правка (нечего
...
def _boundary_direction(entry: dict) -> str | None:
    ...
    старого и нового диапазона (docs/archive/reports/U5A_REPORT.md, вопрос 2: отчёт знал
