...
def test_subset_within_cap(data):
    ...
    Этап T-GOLD-A поднял 28 -> 31: переклассификация сумм в тип SUM добавила
    7 страт, и покрывающего состава короче 29 документов не существует
    (перебор), а детерминированный построитель даёт 31. Полное обоснование —
    в subset_lib.py у самой константы."""
    _, _, doc_ids = data
