...
# =========================================================================== #
# 14 типов сущностей корпуса (README §«Правила разметки»).  Список ФИКСИРОВАН
# и полон, даже если в конкретном прогоне у типа 0 сущностей: гейт обязан
# видеть все 14 колонок, а не только те, что встретились (иначе тип, у
...
ALL_ENTITY_TYPES = (
    ...
    "PHONE", "EMAIL", "PASSPORT", "SNILS", "BIRTHDATE", "SUM",
)
