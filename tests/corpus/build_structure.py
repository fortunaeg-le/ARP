...
docs/archive/reports/PERF_REPORT.md, раздел «Что при этом теряется», п.6 прямо предписывает
...
docs/archive/reports/PERF_REPORT.md §3.3.
...
#                  побайтно то, что перечислено в docs/archive/reports/PERF_REPORT.md §3.3.
