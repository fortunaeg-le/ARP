...
#: ЭТАП DATE-ON (2026-08-18, решение владельца «дату включить во всех наборах»):
#: + `DATE`. Дата в договоре стоит рядом с ФИО, паспортом и органом выдачи и
#: вместе с ними сужает круг лиц; набор, где паспорт и «кем выдан» закрыты, а
#: дата выдачи открыта, защищал бы только на вид — ровно тот довод, которым
#: этап MERGE-2 внёс сюда PASSPORT_ISSUER. Парная строка — `sets:` в
#: tests/corpus_v2/typedefs/DATE.yaml (состав читается ОТТУДА, кортеж ниже —
#: умолчание на случай недоступного конфига).
PERSONAL_DEFAULT = (
    "PERSON", "ADDRESS", "PHONE", "EMAIL", "PASSPORT", "SNILS", "BIRTHDATE",
    "INN_PERSON", "PASSPORT_ISSUER", "DATE",
)
